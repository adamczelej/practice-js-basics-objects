...
console.log( books.getTitle('978-83-7278-000-3', 'en') ); // Harry Potter i Kamień Filozoficzny
console.log( books.getTitle('978-83-7278-000-3', 'pl') ); // Harry Potter and the Philosopher's Stone
